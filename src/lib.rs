...
mod tests {
    ...
    fn test_client_message_serialize() -> () {
        ...
        serialize(&ClientMessage::Chat {
            receiver: client_message::ChatReceiver::Group {
                id: 0
            },
            text: String::from("Hello, world!")
        }).unwrap();
    ...
    fn test_client_message_deserialize() -> () {
        ...
        deserialize::<ClientMessage>(&serialize(&ClientMessage::Chat {
            receiver: client_message::ChatReceiver::All,
            text: String::from("Hello, world!")
        }).unwrap()).unwrap();
    ...
    fn test_server_message_deserialize() -> () {
        ...
        deserialize::<ServerMessage>(&serialize(&ServerMessage::Chat {
            sender: String::from("hunter1"),
            text: String::from("Hello, world!")
        }).unwrap()).unwrap();
